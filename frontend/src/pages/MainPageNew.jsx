...
// 메인 화면 (주소: / )
//
// 예전 메인 화면(MainPage.jsx)은 비교용으로 /old 에 남겨뒀습니다.
// 이 화면으로 가기로 정해지면 그 파일과 App.jsx 의 /old 줄을 지우면 됩니다.
//
// 예전 화면과 다른 점:
//   · 위아래 하늘색 띠와 로고가 없습니다. 배경 그림 한 장이 화면 전체입니다.
//   · 누를 수 있는 건 다이어리 하나뿐입니다.
//     나머지 소품(펜·종이·컵…)은 배경 그림에 같이 그려져 있어 눌리지 않습니다.
//   · 시안 한 장이 창을 꽉 채웁니다. 창 비율이 시안(16:9)과 다르면
//     남는 쪽을 빈 색으로 때우지 않고 가장자리 소품을 조금씩 잘라냅니다.
//     책상이 화면 밖으로 계속 이어지는 느낌이 됩니다. (자세한 건 styles.css)
